<template>
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-2">
            <span class=" font-weight-bold" style="color: rgb(255, 98, 0);">FEATURED PRODUCT</span>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card" >
                    ...
                    <div class="text-center">
                        <img src="https://i.imgur.com/TbtwkyW.jpg" width="230">
                    </div>
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="text-center">
                        <img src="https://i.imgur.com/bUWshC0.jpg" width="230">
                    </div>
                    <div class="text-center card-footer p-3">
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="text-center">
                        <img src="https://i.imgur.com/aTqSahW.jpg" width="230">
                    </div>
                    <div class="text-center card-footer p-3">
